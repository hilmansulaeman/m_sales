...
final class ParseClient
{
    ...
    {
        self::$applicationId = "frei7CdNYRBLpFDLTXvgxCAfMdxLIfQixtOg4AwH";
        self::$restKey = "nzgy6VMCoe0lWMVXVxDwKT6N9dFt2nF9x3JKTlbd";
        self::$masterKey = "r8ockAk1DhmR6JP4DYi9w9gBMMjzui6yrRwmDcfa";
    }

    public static function getServerUrl($mountPath)
    {

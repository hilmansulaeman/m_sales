...
<html lang="en">
  <head>
    ...
    <title>Data Decision Personal Loan (PL) - M-Sales</title>
  ...
  <body>
    ...
    <script>
      // Initialize layout
      initLayout("Data Decision", "Personal Loan (PL)");
      ...
      const viewData = {
        Approve: {
          headers: ["No", "Costumer Name", "DSR", "Date"],
          rows: [
            {
              no: 1,
              name: "AbdXXX XX**** ********",
        ...
        tbody.innerHTML = data.rows
          .map((row) => {
            ...
            if (row.col3 !== undefined) {
              col3Html = `<td class="px-4 py-4 text-center text-sm text-gray-600">${row.col3}</td>`;
            }
            return `
              ...
              <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr class="hover:bg-gray-50 group">
                    ...
                    <!-- Fixed alignment in previous steps, ensuring consistency here -->
                    <td class="px-4 py-4 text-sm text-gray-700">K1141935</td>
                    <td class="px-4 py-4 text-center text-sm text-gray-600">
                      1
                    </td>
                    <td class="px-4 py-4 text-center text-sm text-gray-600">
                    ...
                    <td class="px-4 py-4 text-center">
                      <button
                        class="text-blue-500 hover:text-blue-700 transition-colors p-1.5 rounded-full hover:bg-blue-50"
                      >
                        <i data-lucide="more-horizontal" class="w-5 h-5"></i>
                      </button>
                    </td>

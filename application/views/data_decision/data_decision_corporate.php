...
<html lang="en">
  <head>
    ...
    <title>Data Decision Corporate - M-Sales</title>
  ...
  <body>
    ...
    <script>
      // Initialize layout
      initLayout("Data Decision", "Corporate");
      ...
      function renderTable() {
        ...
        if (paginatedData.length === 0) {
          tbody.innerHTML = `<tr><td colspan="7" class="text-center py-8 text-gray-500">No data found</td></tr>`;
        }
      ...
      const viewData = {
        Approve: {
          headers: ["No", "Costumer Name", "Company Name", "DSR", "Date"],

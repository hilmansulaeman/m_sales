...
<html lang="en">
  <head>
    ...
    <title>Incoming PEMOL - M-Sales</title>
  ...
  <body>
    ...
    <script>
      ...
      main.innerHTML = `
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 w-full lg:w-auto items-center">
                        ...
                        <div class="relative w-full sm:w-72">
                            ...
                            <input
                                type="text"
                                placeholder="Search"
                                class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
                            />
                        </div>
                        ...
                        <div class="relative w-full sm:w-72">
                             <div class="relative cursor-pointer" onclick="toggleDateRangePicker(event)">
                                ...
                                <input type="text" placeholder="Select date range" readonly class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white cursor-pointer placeholder-gray-400"/>
                            </div>
            ...
            <div class="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-200">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="bg-[#1E5BA8] text-white">
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">No</th>
                                <th class="px-4 py-3 text-left text-sm font-medium border-r border-white/20 align-middle" rowspan="2">RSM Name</th>
                                <th class="px-4 py-3 text-left text-sm font-medium border-r border-white/20 align-middle" rowspan="2">NIK Sales</th>
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Branch</th>
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Total DSR</th>
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Total<br>Input DSR</th>
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 border-b" colspan="2">Input</th>
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Total</th>
                                <th class="px-4 py-3 text-center text-sm font-medium align-middle" rowspan="2">Action</th>
                            </tr>
                            <tr class="bg-[#1E5BA8] text-white">
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 w-32">BCA Mobile</th>
                                <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 w-32">My BCA</th>
                            </tr>
                        </thead>
                        <tbody id="tableBody">
                            <!-- Populated via JS -->
               ...
               <div class="px-6 py-4 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-4 bg-white text-sm text-gray-500 w-full">
                    <div id="showingInfo">Showing 1 to 1 of 1</div>

                    <div class="flex items-center gap-2" id="paginationControls">
                         <button class="p-1 hover:text-gray-700 text-gray-400 opacity-50 cursor-not-allowed"><i data-lucide="chevron-left" class="w-4 h-4"></i></button>
                        <span class="w-8 h-8 flex items-center justify-center bg-blue-100 text-blue-600 font-medium rounded-lg">1</span>
                        <button class="p-1 hover:text-gray-700 text-gray-400 opacity-50 cursor-not-allowed"><i data-lucide="chevron-right" class="w-4 h-4"></i></button>
                    </div>

                    <div class="flex items-center gap-2">
                        <span>Show</span>
                        <div class="relative">
                            <select id="rowsPerPageSelect" class="appearance-none border border-gray-200 rounded-lg pl-3 pr-8 py-1.5 bg-white text-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm">
            ...
            <!-- Action Modal -->
            <div id="actionModal" class="hidden fixed inset-0 bg-black/50 z-[100] flex items-center justify-center opacity-0 transition-opacity duration-300 backdrop-blur-sm px-4">
                <div class="bg-white rounded-3xl w-full max-w-[1200px] max-h-[90vh] flex flex-col shadow-2xl transform scale-95 transition-transform duration-300">
                    <!-- Header -->
                    <div class="px-8 py-6 flex items-center justify-between border-b border-gray-100">
                        <h2 id="actionModalTitle" class="text-2xl font-bold text-[#1E3A8A]"></h2>
                    ...
                    <div class="p-8 overflow-y-auto">
                        <!-- Filters -->
                         <div class="flex flex-col sm:flex-row gap-4 mb-6">
                            ...
                            <div class="relative w-full sm:w-72">
                                <i data-lucide="search" class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-4 h-4"></i>
                                <input type="text" placeholder="Search" class="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>

                            <!-- Date Picker -->
                             <div class="relative w-full sm:w-auto">
                                <div class="flex items-center gap-2 px-4 py-2.5 border border-gray-200 rounded-full text-sm text-gray-600 bg-white">
                        ...
                        <div class="overflow-x-auto rounded-lg border border-gray-200">
                            <table class="w-full">
                                <thead class="bg-[#1E5BA8] text-white">
                                    <tr class="bg-[#1E5BA8] text-white">
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">No</th>
                                        <th class="px-4 py-3 text-left text-sm font-medium border-r border-white/20 align-middle" rowspan="2">ASM Name</th>
                                        <th class="px-4 py-3 text-left text-sm font-medium border-r border-white/20 align-middle" rowspan="2">NIK Sales</th>
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Branch</th>
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Total DSR</th>
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 align-middle" rowspan="2">Total<br>Input DSR</th>
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 border-b" colspan="2">Input</th>
                                        <th class="px-4 py-3 text-center text-sm font-medium align-middle" rowspan="2">Total</th>
                                    </tr>
                                    <tr class="bg-[#1E5BA8] text-white">
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 w-32">BCA Mobile</th>
                                        <th class="px-4 py-3 text-center text-sm font-medium border-r border-white/20 w-32">My BCA</th>
                                ...
                                <tbody class="divide-y divide-gray-200 bg-white">
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-4 text-center text-sm text-gray-600 border-r border-gray-100">1</td>
                                        <td class="px-4 py-4 text-sm text-gray-700 border-r border-gray-100">Anggi Nugraha</td>
                                        <td class="px-4 py-4 text-sm text-gray-600 border-r border-gray-100">K1104148</td>
                                        <td class="px-4 py-4 text-center text-sm text-gray-600 border-r border-gray-100">Jakarta</td>
                                        <td class="px-4 py-4 text-center text-sm text-gray-600 border-r border-gray-100">0</td>
                                        <td class="px-4 py-4 text-center text-sm text-gray-600 border-r border-gray-100">0</td>
                                        <td class="px-4 py-4 text-center text-sm text-gray-600 border-r border-gray-100">3</td>
                                        <td class="px-4 py-4 text-center text-sm text-gray-600 border-r border-gray-100">1</td>
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-50">
                ...
                <td class="px-4 py-4 text-sm text-center">
                    <button onclick="openActionModal('${
                      row.rsmName
                    }')" class="text-[#3B6EC2] hover:text-[#2F5BA8] transition-colors">
      ...
      // Modal Logic
      window.openActionModal = function (name) {

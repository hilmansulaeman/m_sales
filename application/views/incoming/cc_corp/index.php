...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">Corporate <?php echo $position; ?></h3> 
		<?php if (in_array($position, $array_structure)) { ?>
			<a href="<?php echo site_url('incoming/cc_corp/view_leader'); ?>" class="btn btn-primary">View Detail</a>
		<?php } ?>
	</div>
	<div class="panel-body">
		<!-- <div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
				<h1 class="page-title txt-color-blueDark"><i class="fa fa-bank fa-fw "></i> 
					<b>Corporate <?php echo $position; ?></b>
				</h1>
			</div>
		</div> -->
		...
		<div class="row">
			<div class="col-md-12">
				<a href="cc_corp/export"><button type="button" id="btn-export" class="btn btn-primary" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data</button></a>
				<!-- <a href="cc_corp/unit_testing_export"><button type="button" id="btn-export" class="btn btn-primary" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data TEST</button></a> -->
				<br><br>
...
$(document).ready(function() {
    table = $("#data-table-customer").DataTable({
		...
		responsive:true,
		ajax: {
		url: "<?php echo site_url('incoming/cc_corp/get_data') ?>",
		type:'POST',
		/*data: function ( data ) {
...
function filter_data()
{
    ...
    $.ajax({
        url : "<?php echo site_url('incoming/cc_corp/filter_data')?>",
        type: "POST",
		data: formData,
		contentType: false,
        processData: false,
...
function view_spv(sales, pos, name)
{
	...
	$.ajax({
		url:"<?php echo site_url('incoming/cc_corp/detailSPV'); ?>/" + sales + "/" + pos,
		type:"POST",
...
function view_detail(sales, nik, status, name)
{
	...
	$.ajax({
		url:"<?php echo site_url('incoming/cc_corp/detail_leader_popup'); ?>/" + sales + "/" + nik + "/" + status,
		type:"POST",

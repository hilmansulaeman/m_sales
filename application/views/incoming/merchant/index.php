...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">Merchant <?php echo $position; ?></h3>
		<?php if (in_array($position, $array_structure)) { ?>
			<?php $safe_name = str_replace(' ', '-',trim($name)); ?>
			<a href="<?php echo site_url('incoming/merchant/detailActualLink/'.$nik.'/'.$position.'/'.$safe_name); ?>" class="btn btn-primary">View Detail</a>
		<?php } ?>
	</div>
	<div class="panel-body">
		<!-- <div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
				<h1 class="page-title txt-color-blueDark"><i class="fa fa-bank fa-fw "></i> 
					<b>Merchant <?php echo $position; ?></b>
				</h1>
			</div>
		</div> -->
			...
			<div class="col-sm-10">
				<span class="pull-right">
					...
					<form id="form_filter" method="post" class="smart-form" novalidate="novalidate"> 		
						<table>
							<tr>
								<td><h6 class="txt-color-blueDark">Source &nbsp; </h6></td>	
								<td>
									<label class="select">
							...
							<tr>
								<td><h6 class="txt-color-blueDark">Periode &nbsp; </h6></td>
								<td>
									<label class="input"> 	
								...
								<td><h6 class="txt-color-blueDark">&nbsp; S/D &nbsp; </h6></td>											
								<td>
									<label class="input"> 							
											<!-- <i class="icon-prepend fa fa- fa-calendar"></i> -->
		...
		<div class="row">
			<div class="col-md-12">
				<h3 style="display: inline-block !important;">Data Input</h3> || 
				<a href="merchant/export"><button type="button" class="btn btn-success" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data</button></a>
				<!-- <a href="merchant/export/edc"><button type="button" class="btn btn-success" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data EDC</button></a> -->
				<br>
				<!-- <a href="merchant/unit_testing_export/qris"><button type="button" class="btn btn-success" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data QRIS TEST</button></a>
				<a href="merchant/unit_testing_export/edc"><button type="button" class="btn btn-success" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data EDC TEST</button></a> -->
			</div>
			<div class="col-md-12">
...
$(document).ready(function() {
    table = $("#data-table-customer").DataTable({
		...
		// }],
		ajax: {
		url: "<?php echo site_url('incoming/merchant/get_data') ?>",
		type:'POST',
		/*data: function ( data ) {
...
function filter_data()
{
    ...
    $.ajax({
        url : "<?php echo site_url('incoming/merchant/filter_data')?>",
        type: "POST",
		data: formData,
		contentType: false,
        processData: false,
...
function view_spv(sales, pos, name)
{
	...
	$.ajax({
		url:"<?php echo site_url('incoming/merchant/detailSPV'); ?>/" + sales + "/" + pos,
		type:"POST",
...
function view_detail(sales, varr, name)
{
	...
	$.ajax({
		url:"<?php echo site_url('incoming/merchant/detailActual'); ?>/" + sales + "/" + varr,
		type:"POST",

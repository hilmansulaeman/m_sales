...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<?php if (in_array($position, $array_structure)) { ?>
			<a href="<?php echo site_url('incoming/pasar_polis/view_leader'); ?>" class="btn btn-primary">View Detail</a>
		<?php } ?>
	</div>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
				<h1 class="page-title txt-color-blueDark"><i class="fa fa-bank fa-fw "></i>
					<b>Pasar Polis <?php echo $position; ?></b>
				</h1>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="table-responsive">
					<table id="data-table-customer" class="table table-hover" width="100%">
						<thead>
							<tr>
								<th width="3px" rowspan="2" style="vertical-align : middle;text-align:left;">No</th>
								<th rowspan="2" style="vertical-align : middle;text-align:left;">Nama Sales</th>
								<th class="text-right">Basic</th>
								<th></th>
								<th class="text-right">Platinum</th>
								<th></th>
							...
							<tr>
								...
								<td width="10%">Premi</tdstyle=>
								<td width="10%">Total</tdstyle=>
								<td width="10%">Premi</td>
								<td width="10%">Total Produk</td>
								<td width="10%">Total Premi</td>
								<td></td>
							</tr>
						</thead>
						<tbody>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		table = $("#data-table-customer").DataTable({
			...
			responsive: true,
			ajax: {
				url: "<?php echo site_url('incoming/pasar_polis/get_data') ?>",
				type: 'POST',
				/*data: function ( data ) {
	...
	function view_spv(sales, pos, name)
{
	...
	$.ajax({
		url:"<?php echo site_url('incoming/pasar_polis/detailSPV'); ?>/" + sales + "/" + pos,
		type:"POST",

...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">CC MS <?php echo $position; ?></h3>
		<?php if (in_array($position, $array_structure)) { ?>
			<a href="<?php echo site_url('incoming/cc_ms/view_leader'); ?>" class="btn btn-primary">View Detail</a>
		<?php } ?>
	</div>
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-md-12">
				<a href="cc_ms/export"><button type="button" id="btn-export" class="btn btn-primary" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data</button></a>
				<!-- <a href="cc_ms/unit_testing_export"><button type="button" id="btn-export" class="btn btn-primary" style="padding:5px;"><i class="fa fa-file-excel-o"></i> Export Data TEST</button></a> -->
				<br><br>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		table = $("#data-table-customer").DataTable({
			...
			responsive: true,
			ajax: {
				url: "<?php echo site_url('incoming/cc_ms/get_data') ?>",
				type: 'POST',
				/*data: function ( data ) {
	...
	function filter_data() {
		...
		$.ajax({
			url: "<?php echo site_url('incoming/cc_ms/filter_data') ?>",
			type: "POST",
			data: formData,
			contentType: false,
			processData: false,
	...
	function view_spv(sales, pos, name) {
		...
		$.ajax({
			url: "<?php echo site_url('incoming/cc_ms/detailSPV'); ?>/" + sales + "/" + pos,
			type: "POST",
	...
	function view_detail(sales, nik, status, name) {
		...
		$.ajax({
			url: "<?php echo site_url('incoming/cc_ms/detail_leader_popup'); ?>/" + sales + "/" + nik + "/" + status,
			type: "POST",

...
<a href="<?= site_url('incoming/sc/index') ?>" class="btn btn-primary">Refresh <i class="fa fa-refresh"></i></a>
...
<script>
	function detailSc(status)
	{
		...
		$.ajax({
            url:'<?php echo site_url(); ?>incoming/sc/det_breakdown_sc/'+ status,
            type:'POST',
	...
	function submit_filter()
	{
		...
		if(tgl1 == "" || tgl2 ==  ""){
			...
			window.location='<?php echo base_url() ?>filter_incoming/index/sc/'+ tgl1 +'/'+ tgl2;
		}

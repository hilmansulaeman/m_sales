...
<a href="<?= site_url('incoming/corp/index') ?>" class="btn btn-primary">Refresh <i class="fa fa-refresh"></i></a>
...
<script>
	function detailCorp(status)
	{
		...
		$.ajax({
            url:'<?php echo site_url(); ?>incoming/corp/det_breakdown_corp/'+ status,
            type:'POST',
	...
	function submit_filter()
	{
		...
		if(tgl1 == "" || tgl2 ==  ""){
			...
			window.location='<?php echo base_url() ?>filter_incoming/index/corp/'+ tgl1 +'/'+ tgl2;
		}
...
<div class="modal fade" id="modalFilter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="<?php echo site_url(); ?>incoming/corp/filter_incoming/">

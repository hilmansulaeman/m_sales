...
$allow_spv = array('P1126810','P1203866','P1801394','P1801385','P1801093','P1800392','P4100213');
?>
<style>
...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">FORM SPV</h3>			  
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
			<?php if(in_array($nik, $allow_spv)){ ?>
				<a href="<?php echo site_url('input/pemol/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Data</a>
			<?php } ?>
			</div>

...
<div id="ribbon">	
	<ol class="breadcrumb">
		...
		<li><i class="fa fa-cloud-upload "></i> &nbsp; Input</li>
		<li>Welma</li>
	</ol>	 
</div>
...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">DATA WELMA</h3>			  
	</div>
	<div class="panel-body">
		<!-- <form id="checkout-form" method="post" enctype="multipart/form-data" class="smart-form" onsubmit="return confirm('Data sudah benar?');" > -->
			<div class="row">
				<div class="col-md-6">
					<a href="<?php echo site_url('input/welma/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span> Add Data</a>
				</div>
				<div class="col-md-6">
...
$(document).ready(function() {
	table = $("#data-table-customer").DataTable({
		...
		responsive:true,
		ajax: {
		url: "<?php echo site_url('input/welma/get_data') ?>",
		type:'POST',
		/*data: function ( data ) {

...
<div class="box box-primary">
	...
	<div class="panel-body">
		<form id="checkout-form" method="post" enctype="multipart/form-data" class="smart-form" onsubmit="return confirm('Data sudah benar?');" >
			<div class="row">
				<div class="col-md-6">
					<a href="<?php echo site_url('input/edc/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span>Input Merchant EDC</a>
				</div>
				<div class="col-md-6">
...
$(document).ready(function() {
	table = $("#table-data").DataTable({
		...
		responsive:true,
		ajax: {
		url: "<?php echo site_url('input/edc/get_data_merchant') ?>",
		type:'POST',
		/*data: function ( data ) {
...
//         responsive:true,
//         ajax: {
// 			url: "<?php echo site_url('sales/edc/get_data_merchant') ?>",
// 			type:'POST',
// 			/*data: function ( data ) {
// 					data.created_date = $('#created_date').val();
// 				}*/

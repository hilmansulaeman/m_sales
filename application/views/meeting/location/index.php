...
<div id="content" class="box box-primary">
	...
	<div class="box-header">
		<div class="btn-group m-b-5">
			<a href="javascript:void(0);" onclick="AddNew();" class="btn btn-default" style="padding:5px;"><i class="fa fa-plus"></i> Tambah Lokasi</a>
		</div>
	</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		tableLocation = $("#data-location").DataTable({
			...
			responsive: true,
			ajax: {
				url: "<?php echo site_url('meeting/location/get_data_location') ?>",
				type: 'POST',
			},

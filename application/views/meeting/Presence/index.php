...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">Meeting Presence Meeting</h3>			  
	</div>
...
$(document).ready(function() {
    table_monitor = $("#data-table-customer").DataTable({
		...
		responsive:true,
		ajax: {
			url: "<?php echo site_url('meeting/presence_meeting/get_data') ?>",
			type:'POST',
			data: function ( data ) {
...
function view_spv(sales, pos, name)
{
	...
	$.ajax({
		url:"<?php echo site_url('meeting/presence_meeting/detail'); ?>/" + sales +"/"+ pos,
		type:"POST",
		data: function ( data ) {

...
<html lang="en">
  <head>
    ...
    <title>Application Check Merchant - M-Sales</title>
  ...
  <body>
    ...
    <script>
      // Initialize Layout
      initLayout("Application Check", "Merchant");
      ...
      main.innerHTML = `
            ...
            <div class="bg-[#3B6EC2] rounded-lg p-8 mb-6 relative overflow-hidden">
                 <!-- Background Pattern (Optional, strictly matching screenshot plain blue is fine too) -->
                <p class="text-white text-center text-lg mb-6 font-medium relative z-10">
                    Please enter the Merchant Name / Owner Name / ID Card Number in the field below
                </p>
      ...
      const tableData = {
        incoming: {
          headers: [
            ...
            { label: "Merchant Name", align: "text-left" },
            { label: "Owner Name", align: "text-left" },
            { label: "Sales Code", align: "text-center" },
            { label: "Product", align: "text-center" },
            { label: "Input Date", align: "text-center" },
            { label: "Submit to BCA", align: "text-center" },
            { label: "Status", align: "text-center" },
            { label: "Receive Date", align: "text-center" },
          ],
          rows: [
            {
              no: 1,
              merchantName: "D'Kriuk Fr**** **********",
              ownerName: "Desi Minnarti",
              salesCode: "K1207647",
              product: "QRIS",
              inputDate: "06-Aug-2025 20:56:41",
              submitToBCA: "06-Aug-2025 21:04:36",
              status: "Submit to BCA",
              receiveDate: "06-Aug-2025 20:56:41",
            },
            {
              no: 2,
              merchantName: "Nitrogen 34*** ****",
              ownerName: "CV Arum Wijaya",
              salesCode: "K1140141",
              product: "EDC + QRIS",
              inputDate: "06-Aug-2025 20:56:41",
              submitToBCA: "06-Aug-2025 21:04:36",
              status: "Return from BCA",
              receiveDate: "06-Aug-2025 20:56:41",
            },
          ],
        },

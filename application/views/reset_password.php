			...
			<div class="dialog-front">
				<div class="dialog-content">
					...
					<div class="well" style="background:#FFFFFF">
						...
						?>
						<p>Silakan input password baru anda</p>
						<form class="login-form" role="form" action="" method="post">
							
							<div class="form-group">
								<label for="email_lupa" style="color:#999999;" class="control-label">Password Baru:</label>
								<input type="password" name="new_password" style="color:#999999;" class="form-control" placeholder="Password Baru" autofocus required />
								<?php echo form_error('new_password'); ?>
							</div>
							<div class="form-group">
								<label for="email_lupa" style="color:#999999;" class="control-label">Konfirmasi Password:</label>
								<input type="password" name="password_conf" style="color:#999999;" class="form-control" placeholder="Konfirmasi Password" required />
								<?php echo form_error('password_conf'); ?>
							</div>
							
							<div class="pad-top-20 pad-btm-20">
								<input type="submit" style="background: linear-gradient(#0099FF, #2C4257),#FFFFFF;"
									class="btn btn-primary btn-block btn-lg" value="Reset Password">
							</div>	
				        </form>
						<?php } ?>

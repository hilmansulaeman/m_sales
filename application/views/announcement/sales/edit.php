                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group m-b-10">
                            ...
                            <textarea class=" form-control" id="announcement_description" name="announcement_description" style="width: 100%; padding:3px; margin:5px" rows="10" required></textarea>
                        </div>

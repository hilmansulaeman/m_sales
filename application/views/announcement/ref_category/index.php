...
<div id="ribbon">
    <ol class="breadcrumb">
        ...
        <li><i class="fa fa-link "></i> &nbsp; Category Announcement</li>
...
<div id="content" class="box box-primary">
    ...
    <div class="box-header with-border">
        ...
        <h3 class="box-title">Ref Announcement Category</h3>
    </div>

    <div class="box-header">
        <div class="btn-group m-b-5">
            <a href="<?php echo site_url(); ?>announcement/ref_category/add" class="btn btn-default" style="padding:5px;"><i class="fa fa-plus"></i> Tambah Kategori</a>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <table id="data-location" class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Category Announcement</th>
                            <th>Schedule</th>
                            <th>Schedule Tanggal</th>
                            <th>Schedule Bulan</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        tableLocation = $("#data-location").DataTable({
            ...
            responsive: true,
            ajax: {
                url: "<?php echo site_url('announcement/ref_category/get_data_ref_category') ?>",
                type: 'POST',
            },

				...
				<table id="mytable" class="table table-hover table-bordered">
					...
					<?php
						...
						foreach ($query->result() as $val) {
							...
							//
							/*$sqlInc = $this->bsh_model->getIncCurrent($val->SPV_Code, $tanggal);
					...
					?>
						<tr>
							...
							<?php
								...
								elseif($rating_ls == "Acceptable" OR $rating_ls == "Acceptable 1" OR $rating_ls == "Acceptable 2")
								{
								...
								elseif($rating_ls == "Excellent" OR $rating_ls == "Excellent 1" OR $rating_ls == "Excellent 2" OR $rating_ls == "Excellent 3")
								{
							...
							<td>
							<?php
								if($ratings == "Under Perform" OR $ratings == "Under Perform 1" OR $ratings == "Under Perform 2" OR $ratings == "Warning" OR $ratings == "Zero Account")
								{
								...
								elseif($ratings == "Excellent" OR $ratings == "Excellent 1" OR $ratings == "Excellent 2" OR $ratings == "Excellent 3")
								{
						...
						<?php
							...
							$sqlBreakdown = $this->bsh_model->getAllDsrBySpv($val->SPV_Code);
							$nod = 0;
							foreach($sqlBreakdown->result() as $req) {

								$sqlDataOld = $this->bsh_model->getAppsLsAllDsr($req->DSR_Code, $tanggal_old);
								...
								//
								/*$qryCurDsr = $this->bsh_model->getIncCurrentDsr($req->DSR_Code, $tanggal);
								...
								$sqlDataNow = $this->bsh_model->getAppsLsAllDsr($req->DSR_Code, $tanggal);
						...
						<tr class="tr_<?php echo $val->SPV_Code; ?>" style='font-size: 11px; display: none;'>
							...
							<td>
							<?php
								if($RatingOld == "Under Perform" OR $RatingOld == "Under Perform 1" OR $RatingOld == "Under Perform 2" OR $RatingOld == "Warning" OR $RatingOld == "Zero Account")
								{
									echo "<span class='label label-danger'>".$RatingOld."</span>";
								}
								elseif($RatingOld == "Acceptable" OR $RatingOld == "Acceptable 1" OR $RatingOld == "Acceptable 2")
								{
								...
								elseif($RatingOld == "Excellent" OR $RatingOld == "Excellent 1" OR $RatingOld == "Excellent 2" OR $RatingOld == "Excellent 3")
								{
							...
							<td>
							<?php
								if($RatingNow == "Under Perform" OR $RatingNow == "Under Perform 1" OR $RatingNow == "Under Perform 2" OR $RatingNow == "Warning" OR $RatingNow == "Zero Account")
								{
									echo "<span class='label label-danger'>".$RatingNow."</span>";
								}
								elseif($RatingNow == "Acceptable" OR $RatingNow == "Acceptable 1" OR $RatingNow == "Acceptable 2")
								{
								...
								elseif($RatingNow == "Excellent" OR $RatingNow == "Excellent 1" OR $RatingNow == "Excellent 2" OR $RatingNow == "Excellent 3")
								{
					...
					?>
						...
						<?php
							$sqlDummy = $this->bsh_model->getDsrDummy($this->uri->segment(3));
							$nods = 0;
							foreach ($sqlDummy->result() as $rDum) {

								$sqlDumLs = $this->bsh_model->getAppsLsAllDsr($rDum->DSR_Code, $tanggal_old);
								...
								//
								/*$qrD = $this->bsh_model->getIncCurrentDsr($rDum->DSR_Code, $tanggal);
								if($qrD->num_rows() > 0)
								{
									$qrDt = $qrD->row();
								...
								$sqlDums = $this->bsh_model->getAppsLsAllDsr($rDum->DSR_Code, $tanggal);
						...
						<tr class="tr_detail2" style='font-size: 11px; display: none;'>
							...
							<td>
							<?php
								if($rtg == "Under Perform" OR $rtg == "Under Perform 1" OR $rtg == "Under Perform 2" OR $rtg == "Warning" OR $rtg == "Zero Account")
								{
									echo "<span class='label label-danger'>".$rtg."</span>";
								}
								elseif($rtg == "Acceptable" OR $rtg == "Acceptable 1" OR $rtg == "Acceptable 2")
								{
									echo "<span class='label label-success'>".$rtg."</span>";
								}
								elseif($rtg == "Standard" OR $rtg == "Standar")
								{
									echo "<span class='label label-warning'>".$rtg."</span>";
								}
								elseif($rtg == "Excellent" OR $rtg == "Excellent 1" OR $rtg == "Excellent 2" OR $rtg == "Excellent 3")
								{
							...
							<td>
							<?php
								if($rtg_dums == "Under Perform" OR $rtg_dums == "Under Perform 1" OR $rtg_dums == "Under Perform 2" OR $rtg_dums == "Warning" OR $rtg_dums == "Zero Account")
								{
									echo "<span class='label label-danger'>".$rtg_dums."</span>";
								}
								elseif($rtg_dums == "Acceptable" OR $rtg_dums == "Acceptable 1" OR $rtg_dums == "Acceptable 2")
								{
									echo "<span class='label label-success'>".$rtg_dums."</span>";
								}
								elseif($rtg_dums == "Standard" OR $rtg_dums == "Standar")
								{
									echo "<span class='label label-warning'>".$rtg_dums."</span>";
								}
								elseif($rtg_dums == "Excellent" OR $rtg_dums == "Excellent 1" OR $rtg_dums == "Excellent 2" OR $rtg_dums == "Excellent 3")
								{

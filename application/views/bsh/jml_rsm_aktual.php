			...
			<div style="height:500px;overflow-y:scroll;">
				<table class="table table-hover table-bordered">
					...
					<?php
						...
						//realtime
						/*$sqlInc = $this->bsh_model->CurrentApps($rows->RSM_Code, $tanggal);
					...
					?>
							<tr>
								...
								<td>
								<?php
									if($rating_old == "Under Perform 1" OR $rating_old == "Under Perform 2"  OR $rating_old == "Under Perform" OR $rating_old == "Warning" OR $rating_old == "Zero Account")
									{
								...
								<td>
									<?php
										if($rating == "Under Perform 1" OR $rating == "Under Perform 2"  OR $rating == "Under Perform" OR $rating == "Warning" OR $rating == "Zero Account")
										{
										...
										}elseif($rating == "Excellent" OR $rating == "Excellent 1" OR $rating == "Excellent 2" OR $rating == "Excellent 3" OR $rating == "Excellent 4")
										{
							...
							<tr class="tr_<?php echo $rows->RSM_Code; ?>" style="font-size: 11px; display: none;">
								...
								<td>
									<?php
										if($ratings_s == "Under Perform 1" OR $ratings_s == "Under Perform 2"  OR $ratings_s == "Under Perform" OR $ratings_s == "Warning" OR $ratings_s == "Zero Account")
										{
							...
							<?php
								...
								$queryDummy = $this->bsh_model->DummyAsm($rows->RSM_Code, $tanggal_old);
								...
								//realtime
								/*$sqlRealDum = $this->bsh_model->DummyAsmReal($rows->RSM_Code, $tanggal);
								...
								$queryDummy2 = $this->bsh_model->DummyAsm($rows->RSM_Code, $tanggal);

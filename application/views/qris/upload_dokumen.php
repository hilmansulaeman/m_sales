...
function imageIsLoaded(e) {
  ...
  $('#previewing').attr('height', '250px');
			...
			<h1 class="page-header">
				<a href="<?php echo site_url();?>input/qris/index/new_merchant" class="btn btn-info"><i class="fa fa-angle-double-left"></i>  Back</a>
				...
				<div class="col-lg-6">
					...
					<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
						...
						<div class="panel-body">
									...
									<div class="form-group m-b-10 p-t-5">
										...
										?>
											...
											<?php
												...
												{
											?>
												<a href="<?php echo site_url();?>input/qris/edit_document/<?php echo $ktp_id;?>">
													<span style="margin-top: 5px" class="btn btn-xs btn-info"><i class="fa fa-md fa-edit" title="Edit Data"></i> Edit KTPs</span>
												</a>
											<?php } else { ?>
												&nbsp;
											<?php } ?>
									...
									<div class="form-group m-b-10 p-t-5">
										...
										?>
											...
											<?php
												...
												{
											?>
												<a href="<?php echo site_url();?>input/qris/edit_document/<?php echo $merchant_id;?>">
									...
									<div class="form-group m-b-10 p-t-5">
										...
										?>
											...
											<?php
												...
												{
											?>
												<a href="<?php echo site_url();?>input/qris/edit_document/<?php echo $product_id;?>">
								...
								<div class="col-md-6">
									<div class="form-group m-b-10 p-t-5">
										...
										<?php
											...
											{
										?>
											<a href="<?php echo site_url();?>input/qris/edit_document/<?php echo $npwp_id;?>">
												<span style="margin-top: 5px" class="btn btn-xs btn-info"><i class="fa fa-md fa-edit" title="Edit Data"></i> Edit NPWP</span>
											</a>
											<a href="<?php echo site_url();?>input/qris/delete_npwp/<?php echo $customer_id;?>/<?php echo $npwp_id;?>" onclick="return confirm('Yakin hapus dokumen?')">
							...
							?>
								<a href="<?php echo site_url();?>input/qris/submit_aplikasi/<?php echo $customer_id;?>" class="btn btn-warning">Submit to APP</a>
			    ...
			    <div class="modal fade" id="ModalKtp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			      	<div class="modal-dialog" role="document">
				        <div class="modal-content">
						    ...
						    <?php echo form_open_multipart('input/qris/save_dokumen/'.$db->RegnoId); ?>

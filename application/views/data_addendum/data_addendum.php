...
<head>
    ...
    <title>Data Addendum - M-Sales</title>
                        ...
                        <table class="w-full text-sm text-center border-collapse">
                            <thead>
                                <tr class="bg-[#1E5BBC] text-white">
                                    ...
                                    <th class="px-4 py-3 font-semibold border-r border-blue-400 text-left">Type</th>
                                    <th class="px-4 py-3 font-semibold border-r border-blue-400">Status</th>
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white text-gray-700">
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-4 text-left">Example Type</td>
                                    <td class="px-4 py-4"><span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-medium">Active</span></td>
                                    <td class="px-4 py-4">
                                        <button class="flex items-center justify-center w-8 h-8 bg-blue-50 text-blue-600 rounded-lg hover:bg-blue-100 transition-colors mx-auto">

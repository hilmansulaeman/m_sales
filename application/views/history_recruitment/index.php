...
<div class="box box-primary">
    ...
    <?php } ?>
    <div class="panel-body bg-inverse text-white">

        <form action="<?php echo site_url('history_recruitment/export/') ?>" id="form_filter" method="POST" class=" form-horizontal">
            <table>
                <tr>
                    <td>
                        <label class="label">&nbsp;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $("#data-table-customer").DataTable({
            ...
            responsive: true,
            ajax: {
                url: "<?php echo site_url('history_recruitment/get_data') ?>",
                type: 'POST',
                /*data: function ( data ) {

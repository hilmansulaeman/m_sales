...
<script>
	...
	function submit_filter() {
		...
		if (tgl1 == "" || tgl2 == "") {
			...
			window.location.href = '<?php echo base_url() ?>incoming/merchant/filter_incoming/' + tgl1 + '/' + tgl2 + '/' + source;
		}
						...
						<div class="input-group">
							<label class="select">
								<select id="source" name="source" class="form-control">
									<option value="ALL">--All--</option>
									<option value="FDM" <?php if (isset($example) && $example=="FDM") echo ' selected';?>>Thomas Finnegan</option>
									<option value="FDM">FDM</option>
									<option value="APPS">Merchant Apps</option>
								</select>
								<?php echo form_error('source'); ?>

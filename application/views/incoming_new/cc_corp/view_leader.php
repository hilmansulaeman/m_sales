...
<a href="<?= site_url('incoming/cc_corp') ?>" class="btn btn-danger">Back</a>
...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="row">
			<div class="col-md-6">
				<h4>Setoran Aplikasi Corporate</h4>
			</div>
			<div class="col-md-6">
...
<script>
	function view_detail(status)
	{
		...
		$.ajax({
            url:"<?php echo site_url('incoming/cc_corp/detail_leader_popup'); ?>/" + sales_code + "/" + nik + "/" + status,
            type:'POST',

...
<a href="<?= site_url('incoming_new/tmcc') ?>" class="btn btn-danger">Back</a>
...
<script>
	function view_detail() {
		...
		$.ajax({
			url: "<?php echo site_url('incoming_new/tmcc/detail_leader_popup'); ?>/" + sales_code + "/" + nik,
			type: 'POST',

...
$send_addon = $query->send_addon == null ? 0 : $query->send_addon;
				...
				<form action="" method="post">
					<table style="width:100%;">
						...
						<tr>
							...
							<td>
								<select name="project" id="project" class="multiple-select2 form-control" required>
									<option value="">-- Pilih Nama Pameran --</option>
	...
	<div class="box-header with-border">
		...
		<div class="box-body">
			...
			<ul class="nav nav-stacked">
				<li><a href="javascript:void(0);" onclick="view_detail('SEND');">SEND BCA NTB<span class="pull-right badge bg-blue"><?php echo $send ?></span></a></li>
				...
				<li><a href="javascript:void(0);" onclick="view_detail('SEND_ADDON');">SEND BCA ADD ON<span class="pull-right badge bg-blue"><?php echo $send_addon ?></span></a></li>
...
<script>
	...
	// 	var url = 'https://dev.ptdika.com/rest-api/api/incoming_cc/getDataInput?sales=K3700312&from=2024-01-01&to=2024-01-31&type=reg&project=Superindo Meruya Jakarta Barat';
	// 	var apiKey = '4ad75498f665ec44c5b91e70c3cf6698';
	// 	var apiUser = 'admindika';
	// 	var apiPass = 'B3ndh1L2019';

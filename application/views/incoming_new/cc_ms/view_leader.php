...
<a href="<?= site_url('incoming_new/cc_ms') ?>" class="btn btn-danger">Back</a>
...
<div class="box box-primary">
	<div class="box-header with-border">
		<div class="row">
			<div class="col-md-6">
				<h4>Total Input CCMS</h4>
			</div>
			<div class="col-md-6">
				<span class="pull-right badge bg-yellow" onclick="view_detail()"><?php echo number_format(count($query)); ?></span>
...
<script>
	function view_detail() {
		...
		$.ajax({
			url: "<?php echo site_url('incoming_new/cc_ms/detail_leader_popup'); ?>/" + sales_code + "/" + nik,
			type: 'POST',

            ...
            <div class='row'>
                ...
                <div class="col-lg-3">
					...
					<a href="<?= site_url('incoming/qris/get_status/'.$this->uri->segment(5).'/'.$this->uri->segment(6)) ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                    </h1>
                </div>
...
$(document).ready(function() {
    table = $("#data-incoming").DataTable({
        ...
        responsive:true,
        ajax: {
          url: "<?php echo site_url('incoming/qris/get_data_incoming') ?>",
          type:'POST',
          /*data: function ( data ) {

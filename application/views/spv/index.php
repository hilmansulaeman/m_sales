	...
	<div class="box-body no-padding">
	  <table class="table table-striped">
		...
		<tr>
			...
			<td><?php echo $targets_noa; ?></td>
			<td><?php echo $total_noa; ?></td>
			<?php
				$hitung_noa = $total_noa - $targets_noa;
				if($hitung_noa > 0)
				{
					$hitung_noa = 0;
				}
				...
				{
					$hitung_noa = $hitung_noa;
				}
			?>
			<td><?php echo $hitung_noa; ?></td>
			<td>

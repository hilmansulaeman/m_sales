...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<h3 class="box-title">Data Jumlah Aplikasi RTS &nbsp;<a href="<?php echo base_url() ?>spv/print_data" target="_blank">Print Data</a></h3>
	</div>
				...
				<table class="table table-striped table-bordered" id="tableid">
					...
					?>
						<tr>
							...
							<td><?php echo $inc; ?></td>
							<td>
								<a href="<?php echo base_url(); ?>spv/detail_rts/<?php echo $row->DSR_Code; ?>" target="_blank"><?php echo $rts; ?></a>
							</td>

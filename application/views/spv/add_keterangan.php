<?php
	$heads = str_replace('_', ' ', $this->uri->segment(4));
	if($heads == "JUMLAH DSR")
	{
		$kets = "Kapan anda akan memenuhi Kuota Jumlah DSR, alasan...";
	}
	elseif($heads == "APLIKASI")
	{
...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<h3 class="box-title">FORM TAMBAH KETERANGAN <?php echo $heads; ?></h3>			  
	</div>
	<div class="panel-body">
	<form action="<?php echo base_url(); ?>spv/simpan_keterangan/<?php echo $this->session->userdata('sl_code'); ?>/<?php echo $this->uri->segment(4); ?>" method="post">

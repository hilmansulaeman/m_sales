...
if($kat == "JUMLAH ASM")
{
	$kets = "Kapan anda akan memenuhi Kuota Jumlah ASM, alasan...";
}elseif($kat == "JUMLAH SPV")
{
...
<div class="box box-primary">
	...
	<form action="<?php echo base_url(); ?>rsm/simpan_keterangan/<?php echo $this->session->userdata('sl_code'); ?>/<?php echo $this->uri->segment(4); ?>" method="post">

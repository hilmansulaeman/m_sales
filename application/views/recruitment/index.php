...
<div class="box box-primary">
	...
	<div class="box-header with-border">
		...
		<h3 class="box-title">Data Pelamar <a href="<?= site_url('recruitment/add') ?>" class="btn btn-info">Input Data</a></h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
				<h1 class="page-title txt-color-blueDark"><i class="fa fa-bank fa-fw "></i>
					<b>List Pelamar <?php echo $this->session->userdata('position') ?></b>
				</h1>
			</div>
		</div>
		<hr>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		table = $("#data-table-customer").DataTable({
			...
			responsive: true,
			ajax: {
				url: "<?php echo site_url('recruitment/get_data') ?>",
				type: 'POST',
				/*data: function ( data ) {

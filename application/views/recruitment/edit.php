                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="area" class="form-control select2" onchange="cekArea(this.value)">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if ($position != 'SPV') { ?>
                                        <select name="spv" class="form-control select2" onchange="cekSPV(this.value)">
                                            <option value="">-- Pilih --</option>
                                            <?php if ($position != 'SPV') {
                                                $sess_code = $this->session->userdata('sl_code');
                                                $sess_position = $this->session->userdata('position');
                                                $sess_name = $this->session->userdata('realname');
                                            ?>
                                                <option value="<?= $sess_code . '|' . $sess_position . '|' . $sess_name ?>"><?= $sess_name . " | " . $sess_position ?></option>
                                            <?php } ?>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (post == "ASM") {
                        ...
                        $("#spv_code").val(nik) //ngambil dari nik session yg login
                        $("#spv_name").val(name)
                        $("#asm_code").val(data.SM_Code)
                        $("#asm_name").val(data.SM_Name)
                        $("#rsm_code").val(data.RSM_Code)

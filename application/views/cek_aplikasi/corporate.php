	    ...
	    <form action="" method="get" class="form-horizontal">
            <div class="box-body">
			    <div class="form-group">
					<label>Silahkan input Nama / Nomor KTP / Nama Perusahaan di kolom pencarian di bawah :</label>
...
<?php if($key != ''){ ?>
    <div class="box box-primary">
		<div class="box-header with-border">
			<h4>Data Incoming Corporate<small></small></h4>
			<div class="box-tools pull-right">
				<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
			</div>
		</div>
					...
					?>
						<tr>
							<td>
								...
								<b>Company Name : <?php masking_name($row->Company_Name); ?></b><br>
	...
	<div class="box box-primary">
		<div class="box-header with-border">
			<h4>Data Approval Corporate<small></small></h4>
			<div class="box-tools pull-right">
				<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
			</div>
		</div>

				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
						...
						<div class="panel-body">
							<?php echo form_open_multipart('input/merchant/update_document/'.$db->customer_id); ?>
							<input type="hidden" name="image_old" value="<?php echo $db->image_name;?>">
							    ...
							    <div class="form-group">
								    ...
								    <a href="<?php echo site_url();?>input/merchant/upload_dokumen/<?php echo $db->customer_id;?>">

...
<div id="ribbon">
	...
	<ol class="breadcrumb">
		...
		<li><i class="fa fa-cloud-upload "></i> &nbsp; Merchant</li>
		<li>Index</li>
	</ol>	 
</div>
...
<div class="box box-primary">
	...
	<div class="panel-body">
		<form id="checkout-form" method="post" enctype="multipart/form-data" class="smart-form" onsubmit="return confirm('Data sudah benar?');" >
			<div class="row">
				<div class="col-md-6">
					<a href="<?php echo site_url('input/merchant/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span>Add Data</a>
				</div>
				<div class="col-md-6">
		...
		<table id="data-merchant" class="table table-hover" width="100%">
			<thead>											
				<tr>				 											 				
					<th>No</th>
					<th>Owner Name</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		table = $("#data-merchant").DataTable({
			...
			responsive:true,
			ajax: {
			url: "<?php echo site_url('input/merchant/get_data_merchant') ?>",
			type:'POST',
			/*data: function ( data ) {

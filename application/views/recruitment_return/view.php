...
<div id="content" class="content">
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="breadcrumb-item"><a href="<?php echo site_url('recruitment_return'); ?>">Verifikasi</a></li>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Return To Pelamar</h4>
            </div>
            <!-- end panel-heading -->
            <!-- begin panel-body -->
                    ...
                    <div class="col-md-12 pull-right">
                        ...
                        <div class="form-group row">
                            <div class="col-md-9 offset-md-3">
                                ...
                                <a href="javascript:;" id="btnReturn" class="btn btn-danger" onClick="actionreturn(<?php echo $rows->Approval_ID; ?>)"><i class="fa-fw fa fa-thumbs-down"></i> Return</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#form_return').submit(function(e) {
            ...
            // let app_id = '<?php echo $rows->Approval_ID; ?>';
            var rec_id = <?php echo $rows->Recruitment_ID; ?>;

            var url = "<?php echo site_url('recruitment_return/return/'); ?>" + rec_id;
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status) {
                        ...
                        window.location.href = "<?php echo site_url('recruitment_return') ?>";
                    } else {
                        alert("Proses return gagal, " + data.message);
                        window.location.href = "<?php echo site_url('recruitment_return/return_data/') ?>" + app_id;
                    }
                },
...
<div class="modal fade" id="modal_form_return" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="smart-form" action="<?php echo site_url('recruitment_return/return/' . $rows->Recruitment_ID); ?>" method="POST" id="form_return">

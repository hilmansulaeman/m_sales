		...
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tr>
					<td>6.</td>
					<td>MP Reward</td>
					<td><?php echo number_format($rows->mp_reward); ?></td>
				</tr>
				<tr>
					<td></td>
			...
			<table class="table table-hover">
				...
				<tr>
					<td>6.</td>
					<td>Potongan BPJS BPU</td>
					<td><?php echo number_format($rows->Potongan_BPJS_BPU); ?></td>
				</tr>
				<tr>
					<td></td>
					...
					<?php
						$total_potongan = 0;
						$total_potongan = $rows->Pajak + $rows->Potongan_Seragam + $rows->Potongan_Punishment + $rows->Potongan_Mopro + $rows->Potongan_Lain + $rows->Potongan_BPJS_BPU;
					?>

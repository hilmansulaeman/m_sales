...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Form Struktur</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Permintaan Form Strukture</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($position == 'BSH') {
                                                if ($r->Status == '0') {
                                                    $get_status = $this->db->query("SELECT * FROM data_request_approval WHERE Request_User_ID = '$request_user_id' AND Position = 'BSH' AND Status = '0'")->row();
                                            ...
                                            if ($position == 'GM') {
                                                $get_status = $this->db->query("SELECT * FROM data_request_approval WHERE Request_User_ID = '$request_user_id' AND Position = 'BSH' AND Status = '1'")->row();
                                                $sales_name = $get_status->Sales_Name;
                                            }

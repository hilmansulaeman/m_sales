            ...
            <div class="box">
                ...
                <div class="box-body">
                    <table id="data-request" class="table table-responsive table-bordered table-striped">
                        ...
                        <form action="<?= site_url(); ?>approval_request/reaktif_form/approve/<?= $request_id ?>" method="POST" onsubmit="return validate(this);">
                            <tbody>
                                <?php
                                $no = 1;
                                ...
                                ?>
                                    <tr>
                                        <?php
                                        $q = $this->db->get_where('data_request_approval', array('Sales_Code' => $username, 'Request_User_ID' => $request_user_id))->row();
                                        ...
                                        <?php echo $r->Created_Name; ?>
                                            ...
                                            <input type="hidden" name="efective_date[]" value="<?php echo $r->Efective_Date; ?>">
                                        </td>
                                        <td>
                                            <?php
                    ...
                    ?>
                        ...
                        <input type="submit" class="btn btn-danger" formaction="<?php echo site_url(); ?>approval_request/reaktif_form/reject/<?= $request_id ?>" name="reject" value="Tolak" onclick="return confirm('Yakin tolak data ini?')">
                    <?php } else { ?>
                        <a href="<?= site_url() ?>approval_request/reaktif_form" class="btn btn-primary">Back</a>
                    <?php } ?>

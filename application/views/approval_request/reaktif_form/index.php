...
<section class="content-header">
  <h1>
    <a href="<?= site_url('approval_request/reaktif_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $("#data-request").DataTable({
      ...
      responsive: true,
      ajax: {
        url: "<?php echo site_url('approval_request/reaktif_form/get_data_reaktif') ?>",
        type: 'POST',
        data: function(data) {

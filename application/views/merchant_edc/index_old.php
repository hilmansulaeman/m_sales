...
<div class="box box-primary">
	...
	<div class="panel-body">
		<form id="checkout-form" method="post" enctype="multipart/form-data" class="smart-form" onsubmit="return confirm('Data sudah benar?');" >
			<div class="row">
				<div class="col-md-6">
					<a href="<?php echo site_url('insentif/merchant_edc/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span>Input Merchant EDC</a>
				</div>
				<div class="col-md-6">
			...
			<tbody>
				...
				foreach ($getData as $row) { ?>
					<tr>
						...
						<td><?= $row->Mobile_Phone_Number ?></td>
						<td>
							<span class="pull-right">
								<a href="<?= site_url('insentif/merchant_edc/edit/'.$row->RegnoId) ?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a>
							</span>
						</td>
					</tr>
				<?php } ?>

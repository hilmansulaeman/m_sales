...
<section class="content-header">
  <h1>
    <a href="<?php echo site_url('request/exit_form/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span> Tambah Data</a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $("#data-request").DataTable({
      ...
      responsive: true,
      ajax: {
        url: "<?php echo site_url('request/exit_form/get_data_exit') ?>",
        type: 'POST',
        data: function(data) {

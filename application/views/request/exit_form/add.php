            ...
            <div class="box-body">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="exit_reason" required>
                        <option value="">-- Pilih --</option>
                        <?php
...
// url2:2;
    ...
    $.ajax({
        url: "<?= base_url();?>request/exit_form/getDate/" + val,
        type: "POST",
        data: {
            effective_date: val
        },
        ...
        success: function (response) {
          if(response.status)
          {
            ...
            if(knfrm)
            {
              window.location.href = '<?= base_url();?>request/exit_form/detail/'+response.request_id+'/'+response.category_id;
            }
            else {
              location.reload();
            }

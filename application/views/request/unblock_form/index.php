    ...
    <section class="content-header">
      <h1>
        <a href="<?php echo site_url('request/unblock_form/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span> Tambah Data</a>
        <a href="<?= site_url('request/unblock_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
      ...
      <ol class="breadcrumb">
        ...
        <li>Data Request</li>
        <li class="active">Unblock Form</li>
      </ol>
    </section>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
      table = $("#data-request").DataTable({
          ...
          responsive:true,
          ajax: {
            url: "<?php echo site_url('request/unblock_form/get_data_unblock') ?>",
            type:'POST',
            data: function ( data ) {

...
<section class="content">
  ...
  <div class="row">
    ...
    <form method="POST" action="<?php echo site_url(); ?>request/deviasi_form/save_request_deviasi/<?php echo $this->uri->segment(3); ?>/0">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group date">
                  ...
                  <input type="date" name="efective_date" class="form-control" id="ed" autocomplete="off" onChange="cekBulan(this.value)">
                  <!--Category-->
...
<script type="text/javascript">
  ...
  function cekBulan(val) {
    ...
    // console.log(val);
    $.ajax({
        url: "<?= base_url();?>request/deviasi_form/getDate/" + val,
        type: "POST",
        data: {
            effective_date: val
        },
        ...
        success: function (response) {
          ...
          if(response.status)
          {
            ...
            if(knfrm)
            {
              window.location.href = '<?= base_url();?>request/deviasi_form/detail/'+response.request_id+'/'+response.category_id;
            }
            else {
              location.reload();
            }

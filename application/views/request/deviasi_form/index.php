...
<section class="content-header">
  <h1>
    <a href="<?php echo site_url('request/deviasi_form/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span> Tambah Data</a>
    <a href="<?= site_url('request/deviasi_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $("#data-request").DataTable({
      ...
      responsive: true,
      ajax: {
        url: "<?php echo site_url('request/deviasi_form/get_data_deviasi') ?>",
        type: 'POST',
        data: function(data) {

...
<section class="content-header">
  <h1>
    <a href="<?php echo site_url('request/reaktif_form/add'); ?>" class="btn btn-header btn-labeled btn-primary"><span class="btn-label"><i class="fa fa-plus"></i></span> Tambah Data</a>
    <a href="<?= site_url('request/reaktif_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
            ...
            <table id="data-request" class="table table-responsive table-bordered table-striped">
              <thead>
                <tr>
                  ...
                  <th width="9%">Komplit</th>
                  <th width="9%">Di Kembalikan</th>
                  <th width="9%">Di tolak</th>
                  <th width="9%">Di Batalkan</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $("#data-request").DataTable({
      ...
      responsive: true,
      ajax: {
        url: "<?php echo site_url('request/reaktif_form/get_data_reaktif') ?>",
        type: 'POST',
        data: function(data) {

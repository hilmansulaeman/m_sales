    ...
    <section class="content-header">
      <h1>
        <a href="<?= site_url('request/restruct_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#form_id').change(function(){
      ...
      var aaa = $('#form_action').attr('action', '<?php echo site_url();?>request/restruct_form/add/'+val);
  ...
  $(document).ready(function() {
      table = $("#data-request").DataTable({
          ...
          responsive:true,
          ajax: {
            url: "<?php echo site_url('request/restruct_form/get_data_restruct') ?>",
            type:'POST',
            data: function ( data ) {

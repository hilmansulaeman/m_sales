...
<section class="content">
    ...
    <div class="row">
        ...
        <form method="POST" action="<?php echo site_url(); ?>request/level_form/save_request_level/<?= $uri3 ?>/<?= $request_id ?>">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="data-request" class="table table-responsive table-bordered table-striped">
                            ...
                            <?php echo form_open('request/level_form/send/' . $request_id); ?>
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($request_user->result() as $r) {
                                    ...
                                    $this->db->limit(1);
                                    $cek_status = $this->db->get()->num_rows();
                                    ...
                                    if ($hit_code == '1010') {
                                        ...
                                        if ($cek_status > 0) {
                                            ...
                                            else if($hit_code == '1006') {
                                                $class = 'btn-success';
                                                $status = "Request Komplit ";
                                                $by = '';
                                            }
                                            else {
                                                if ($data->Status == '1') {
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?>
                                            <td>
                                                <a href="<?php echo site_url(); ?>request/level_form/delete_detail/<?php echo $request_id; ?>/<?php echo $r->Request_User_ID; ?>/<?php echo $category_id; ?>" onclick="return confirm('Yakin Hapus?')"><span class="btn btn-xs btn-danger"><i class="fa fa-md fa-trash" title="Delete Data"></i></span></a>
                                            </td>
                                        <?php } else { ?>
                                            <td>
                    ...
                    if ($row == 0) { ?>
                        <p></p>
                    <?php } else { ?>
                        <input formaction="<?php echo site_url(); ?>request/level_form/send/<?= $request_id ?>" type="submit" class="btn btn-info" name="simpan" value="Kirim Permintaan >>" float="right" onclick="return confirm('Yakin kirim permintaan?')">
                    <?php } ?>

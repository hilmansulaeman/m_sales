...
<section class="content-header">
  <h1>
    <a href="<?= site_url('request/level_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Kategori<span style="color:red">*</span></h3>
        </div>
        <div class="box-body">
          <div id="aksi">
          ...
          <div class="row">
            <div class="col-md-3">
              <select class="form-control select2" name="form_id" id="form_id" style="width: 100%" ; required>
            ...
            <div class="col-md-3">
              <button type="submit" class="btn btn-primary btn-md"><i class="fa fa-plus"></i> &nbsp; Buat Permintaan</button>
            </div>
          </div>
        </div>
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Permintaan Form Level</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#form_id').change(function() {
      var val = $(this).val(); //ex : exit_form, reactive_form, dll

      var aaa = $('#form_action').attr('action', '<?php echo site_url(); ?>request/level_form/add/' + val);
  ...
  $(document).ready(function() {
    table = $("#data-request").DataTable({
      ...
      responsive: true,
      ajax: {
        url: "<?php echo site_url('request/level_form/get_data_level') ?>",
        type: 'POST',
        data: function(data) {

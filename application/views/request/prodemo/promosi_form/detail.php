...
<script type="text/javascript">
  function getDetailSales() {
    ...
    $.ajax({
      url: "<?php echo site_url(); ?>request/promosi_form/getDetailSales/" + code,
      dataType: "json",
      type: 'GET',
...
<section class="content">
  ...
  <div class="row">
    ...
    <form method="POST" action="<?php echo site_url(); ?>request/promosi_form/save_request_promosi/<?= $uri3 ?>/<?= $request_id ?>">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="data-request" class="table table-responsive table-bordered table-striped">
            ...
            <?php echo form_open('request/promosi_form/send/' . $request_id); ?>
            <tbody>
              <?php
              $no = 1;
              ...
              ?>
                <tr>
                  ...
                  ?>
                    <td>
                      <a href="<?php echo site_url(); ?>request/promosi_form/delete_detail/<?php echo $request_id; ?>/<?php echo $r->Request_User_ID; ?>" onclick="return confirm('Sure to delete?')"><span class="btn btn-xs btn-danger"><i class="fa fa-md fa-trash" title="Delete Data"></i></span></a>
                    </td>
                  <?php } else { ?>
                    <td>
          ...
          ?>
            <?php if ($checker == $approval) { ?>
              <input type="submit" class="btn btn-success" formaction="<?php echo site_url(); ?>request/promosi_form/send/<?= $request_id . '/' . $checker ?>" name="finish" value="FINISH" onclick="return confirm('Sure to Finish?')">
            <?php } else { ?>

...
<section class="content-header">
  <h1>
    <a href="<?= site_url('request/Prodemo_form') ?>" class="btn btn-info">Refresh <i class="fa fa-refresh"></i></a>
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Data Promosi & Demosi</li>
  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <div id="aksi">
            <form method="POST" action="<?php echo site_url('request/prodemo_form/kategori'); ?>" id="form_action">
          </div>
          <div class="row">
            <div class="col-md-3">
        ...
        <div class="box">
          <div class="box-header">
            ...
            <p></p>
            <h3 class="box-title">Permintaan Form Promosi & Demosi</h3>
          </div>
          <!-- /.box-header -->
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    table = $("#data-request").DataTable({
      ...
      responsive: true,
      ajax: {
        url: "<?php echo site_url('request/prodemo_form/get_data_prodemo') ?>",
        type: 'POST',
        data: function(data) {

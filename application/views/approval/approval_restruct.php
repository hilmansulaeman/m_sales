...
<body>
    ...
    <script>
        ...
        const tableData = [
            { id: 1, date: "-", created: "-", by: "-", amount: "-", approved: "-", rejected: "-", action: "-" },
            // Mock data
            { id: 2, date: "2023-10-01", created: "2023-09-25", by: "Admin A", amount: "5", approved: "3", rejected: "1", action: "View" },
            { id: 3, date: "2023-10-05", created: "2023-09-28", by: "Admin B", amount: "2", approved: "2", rejected: "0", action: "View" }
        ];
        ...
        function renderTable() {
            ...
            if (paginatedItems.length === 0) {
                tbody.innerHTML = '<tr><td colspan="8" class="text-center py-4 text-gray-500">No data found</td></tr>';
                return;
            }

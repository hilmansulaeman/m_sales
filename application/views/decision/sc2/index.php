				...
				<ul class="nav nav-stacked">
					<li>
						<a href="javascript:void(0);"
							onclick="detail_sc('APPROVED', '<?php echo $tgl; ?>')">APPROVE<span
								class="pull-right badge bg-green"><?php echo $br_sc->approve_sc; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_sc('IN_PROSSES', '<?php echo $tgl; ?>')">IN
							PROSSES<span class="pull-right badge bg-green">0</span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_sc('CANCEL', '<?php echo $tgl; ?>')">CANCEL<span
								class="pull-right badge bg-green"><?php echo $br_sc->cancel_sc; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);"
							onclick="detail_sc('DECLINED', '<?php echo $tgl; ?>')">DECLINE<span
								class="pull-right badge bg-green"><?php echo $br_sc->decline_sc; ?></span></a>
					</li>
				</ul>
			</div>
		</div>
...
<script>
	function detail_sc(status, tanggal) {
		...
		$.ajax({
			url: '<?php echo site_url(); ?>decision/sc/det_breakdown_sc/' + status + '/' + tanggal,
			type: 'POST',

				...
				<ul class="nav nav-stacked">
					<li>
						<a href="javascript:void(0);"
							onclick="detail_pl('APPROVED', '<?php echo $tgl; ?>')">APPROVE<span
								class="pull-right badge bg-green"><?php echo $br_pl->approve_pl; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_pl('IN_PROSSES', '<?php echo $tgl; ?>')">IN
							PROSSES<span class="pull-right badge bg-green">0</span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_pl('CANCEL', '<?php echo $tgl; ?>')">CANCEL<span
								class="pull-right badge bg-green"><?php echo $br_pl->cancel_pl; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);"
							onclick="detail_pl('DECLINED', '<?php echo $tgl; ?>')">DECLINE<span
								class="pull-right badge bg-green"><?php echo $br_pl->decline_pl; ?></span></a>
					</li>
				</ul>
			</div>
		</div>
...
<script>
	function detail_pl(status, tanggal) {
		...
		$.ajax({
			url: '<?php echo site_url(); ?>decision/pl/det_breakdown_pl/' + status + '/' + tanggal,
			type: 'POST',

		...
		<div class="box box-widget widget-user-2">
			...
			<div class="box-footer no-padding">
				<ul class="nav nav-stacked">
					<li>
						<a href="javascript:void(0);" onclick="detail_cc('APPROVE', '<?php echo $tgl; ?>')"
							href="<?php echo base_url() ?>decision/cc/det_breakdown_cc/APPROVE/<?php echo $tgl; ?>">APPROVE<span
								class="pull-right badge bg-green"><?php echo $br_cc->approve_cc; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_cc('IN_PROSSES', '<?php echo $tgl; ?>')">IN
							PROSSES<span class="pull-right badge bg-green">0</span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_cc('CANCEL', '<?php echo $tgl; ?>')">CANCEL<span
								class="pull-right badge bg-green"><?php echo $br_cc->cancel_cc; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_cc('DECLINE', '<?php echo $tgl; ?>')">DECLINE<span
								class="pull-right badge bg-green"><?php echo $br_cc->decline_cc; ?></span></a>
					</li>
				</ul>
			</div>
		</div>
...
<script>
	function detail_cc(status, tanggal) {
		...
		$.ajax({
			url: '<?php echo site_url(); ?>decision/cc/det_breakdown_cc/' + status + '/' + tanggal,
			type: 'POST',

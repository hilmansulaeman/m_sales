				...
				<ul class="nav nav-stacked">
					<li>
						<a href="javascript:void(0);"
							onclick="detail_corp('APPROVED', '<?php echo $tgl; ?>')">APPROVE<span
								class="pull-right badge bg-green"><?php echo $br_corp->approve_corp; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail_corp('CANCEL', '<?php echo $tgl; ?>')">CANCEL<span
								class="pull-right badge bg-green"><?php echo $br_corp->cancel_corp; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);"
							onclick="detail_corp('DECLINED', '<?php echo $tgl; ?>')">DECLINE<span
...
<script>
	function detail_corp(status, tanggal) {
		...
		$.ajax({
			url: '<?php echo site_url(); ?>decision/corp/det_breakdown_corp/' + status + '/' + tanggal,
			type: 'POST',

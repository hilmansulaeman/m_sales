	...
	<div class="box-header with-border">
		...
		<div class="box-body">
			...
			<ul class="nav nav-stacked">
				...
				<li><a href="javascript:void(0);">Point<span class="pull-right badge bg-yellow"><?= $totalPointKredit2 ?></span></a></li>
				...
				<li><a href="javascript:void(0);">Point<span class="pull-right badge bg-yellow"><?= $totalPointNonKredit2 ?></span></a></li>
				<!-- END NEW -->
				...
				<li><a href="javascript:void(0);">Point<span class="pull-right badge bg-yellow"><?= $totalPointsExisEDC2 ?></span></a></li>
				<!-- END EXISTING -->
...
<script>
	function detailMerchant(mid, ft, product)
	{
		...
		var sales = $('#sales').val();
		var fas = ft.replace(' ', '-');
		window.open('<?php echo site_url('decision/merchant/det_breakdown_merchant_leader'); ?>/' + sales_code + '/' + sales + '/' + mid + '/' + fas + '/' + product + '/link', '_blank');
	}
</script>

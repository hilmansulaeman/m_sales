...
<div class="box box-success collapsed-box">
	<div class="box-header with-border">
		...
		<span class="pull-right badge bg-yellow"><?php echo 0 + $br_pl->count_app_pl; ?></span>
				...
				<ul class="nav nav-stacked">
					...
					<li>
						<a href="javascript:void(0);"
							onclick="detail('APPROVED')">APPROVE<span
								class="pull-right badge bg-green"><?php echo 0 + $br_pl->approve; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail('INPROCESS')">INPROCESS<span
								class="pull-right badge bg-green"><?php echo 0 + $br_pl->cancel; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);" onclick="detail('CANCEL')">CANCEL<span
								class="pull-right badge bg-green"><?php echo 0 + $br_pl->cancel; ?></span></a>
					</li>
					<li>
						<a href="javascript:void(0);"
							onclick="detail('DECLINED')">DECLINE<span
								class="pull-right badge bg-green"><?php echo 0 + $br_pl->decline; ?></span></a>
					</li>
				</ul>
			</div>
		</div>
...
<script>
	function detail(status) {
		...
		$.ajax({
			url: '<?php echo site_url(); ?>decision/pl/detailActual/' + sales_code + '/' + status,
			type: 'POST',
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" name="date" id="dt_startDate" class="form-control date-input"
								value="<?php echo $this->session->userdata('groupDate'); ?>" placeholder="Y-m"
								autocomplete="off" />
						</div>
					</div>

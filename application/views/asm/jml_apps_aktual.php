...
<div class="box box-primary">
	<div class="box-header with-border">
		...
		<h3 class="box-title">Data Aplikasi Aktual</h3>			  
	</div>
			...
			<div style="height:500px;overflow-y:scroll;">
				<table class="table table-hover">
					...
					<?php
						...
						{
							$jmlAps = $dt->cc + $dt->edc + $dt->sc + $dt->pl + $dt->corp;
					?>
						<tr>
							<td><?php echo ++$no; ?></td>
							<td><?php echo $dt->SPV_Code; ?></td>
							<td><?php echo $dt->SPV_Name; ?></td>
							<td><?php echo $jmlAps; ?></td>
						</tr>
					<?php
						$tot += $jmlAps;
						}

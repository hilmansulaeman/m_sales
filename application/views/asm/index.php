	...
	<div class="box-body no-padding">
	  <table class="table table-striped">
		...
		<tr>
			...
			<td><?php echo $dtTargetSpv; ?></td>
			<td>
				<a data-fancybox href="<?php echo base_url(); ?>asm/jml_spv_aktual_new/<?php echo $this->session->userdata('sl_code'); ?>"><?php echo $aktSpv; ?></a>
			</td>
		...
		<tr>
			...
			<td><?php echo $dtTargetNoa ?></td>
			<td><?php echo $total_noa; ?></td>
			<?php
				$hitNoa = $total_noa - $dtTargetNoa;
				if($hitNoa > 0)
				{
					$hitNoa = 0;
				}
			...
			?>
			<td><?php echo $hitNoa; ?></td>
			<td>
				<a data-fancybox href="<?php echo base_url(); ?>asm/add_keterangan/<?php echo $this->session->userdata('sl_code'); ?>/ACCOUNT" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Komitmen</a>
				<a data-fancybox href="<?php echo base_url(); ?>asm/komitmen_view/<?php echo $this->session->userdata('sl_code'); ?>/ACCOUNT" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
				<a data-fancybox href="<?php echo base_url(); ?>asm/komitmen_others/<?php echo $this->session->userdata('sl_code'); ?>/ACCOUNT" class="btn btn-primary btn-sm"><i class="fa fa-users"></i></a>
			</td>
		</tr>
		<tr>
			<?php
		...
		<tr>
			...
			?>
			<td>
				<a data-fancybox href="<?php echo base_url(); ?>asm/jml_under_aktual_new/<?php echo $this->session->userdata('sl_code'); ?>"><?php echo $rwUnder; ?></a>
			</td>

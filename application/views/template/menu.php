      ...
      <ul class="sidebar-menu">
        ...
        <li class="<?= activate_menu('dashboard'); ?>"><a href="<?php echo site_url() ?>"><i class="fa fa-home"></i><span>Home </span></a></li>
			...
			<?php } else { ?>
				...
				<?php
					if (in_array($posisi, ['SPV', 'ASM', 'RSM', 'BSH'])) {
						?>
					<li class="treeview <?= activate_menu('incoming_new'); ?>">
						<a href="#"><i class="fa fa-link"></i> <span>Incoming</span> <!-- input -->
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li>
								<a href="<?php echo site_url('incoming_new/cc_ms') ?>"><i class="fa fa-info"></i><span>CCMS</span></a>
							</li>
							<li>
								<a href="<?= site_url('incoming_new/pemol') ?>"><i class="fa fa-info"></i>Pemol</a>
							</li>
							<li>
								<a href="<?= site_url('incoming_new/tmcc') ?>"><i class="fa fa-info"></i>TM CC</a>
							</li>
							<li>
								<a href="<?= site_url('incoming_new/tmsc') ?>"><i class="fa fa-info"></i>TM SC</a>
							</li>
						</ul>
					</li>
				<?php } ?>
				...
				<!-- <?php if(in_array($posisi,['ASM','RSM','BSH'])){?>
				<li><a href="<?php echo site_url('recruitment') ?>"><i class="fa fa-user"></i> <span>Data Pelamar </span></a></li>
				<?php } ?> -->

				

				<?php if (in_array($posisi, ['SPV', 'ASM', 'RSM', 'BSH'])) { ?>
					<!-- <li><a href="<?php echo site_url('recruitment') ?>"><i class="fa fa-user"></i> <span>Data Pelamar</span></a></li> -->

					<!-- Input Pelamar -->
					<li class="treeview">
						<a href="#"><i class="fa fa-search"></i> <span>Data Pelamar</span>
							<span class="pull-right-container">
								<i class="fa fa-angle-left pull-right"></i>
							</span>
						</a>
						<ul class="treeview-menu">
							<li>
								<a href="<?php echo site_url('recruitment') ?>"><i class="fa fa-book"></i><span>Data Pelamar </span></a>
							</li>

							<!--ASM, RSM, BSH-->
							<?php if (in_array($posisi, ['ASM', 'RSM', 'BSH'])) { ?>
								<li>
									<a href="<?php echo site_url('recruitment_approval') ?>"><i class="fa fa-user"></i><span>Approval </span></a>
								</li>
							<?php } ?>
							<?php if (in_array($posisi, ['ASM', 'RSM', 'BSH'])) { ?>

								<li>
									<a href="<?php echo site_url('history_recruitment') ?>"><i class="fa fa-history"></i><span>History </span></a>
								</li>
							<?php } ?>
						</ul>
					</li>

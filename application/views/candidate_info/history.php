...
<body>
    ...
    <script>
        initLayout("Candidate Info", "History");
                        ...
                        <table class="w-full text-sm text-left border-collapse">
                            <thead>
                                <tr class="bg-[#1E5BBC] text-white">
                                    ...
                                    <th class="px-4 py-3 font-semibold text-left">Candidate Information</th>
                                </tr>
                            </thead>
        ...
        const tableData = [
            { id: 1, info: "No history recorded" },
            // Mock data for pagination testing
            { id: 2, info: "Candidate updated profile" },
            { id: 3, info: "Candidate applied for new position" }
        ];
        ...
        function renderTable() {
            ...
            if (paginatedItems.length === 0) {
                tbody.innerHTML = '<tr><td colspan="2" class="text-center py-4 text-gray-500">No data found</td></tr>';
                return;
            }
            ...
            tbody.innerHTML = paginatedItems.map((item, index) => `
                <tr class="hover:bg-gray-50 border-b border-gray-100">
                    ...
                    <td class="px-4 py-4 text-left">${item.info}</td>
                </tr>
            `).join("");
        }

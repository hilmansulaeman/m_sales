...
<html lang="en">
  ...
  <body>
    ...
    <script>
      initLayout("Request to HRD", "Restruct");
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-4 border-b border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
                        <div class="flex items-center gap-3 w-full md:w-auto flex-1">
                            ...
                            <!-- Sort -->
                            <button class="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-full text-sm text-gray-600 hover:bg-gray-50 transition-colors bg-white">
      ...
      function renderTable() {
        ...
        if (paginatedItems.length === 0) {
          tbody.innerHTML =
            '<tr><td colspan="9" class="text-center py-4 text-gray-500">No data found</td></tr>';
          return;
        }
          ...
          .map(
            (item, index) => `
                <tr class="hover:bg-gray-50 border-b border-gray-100">
                    ...
                    <td class="px-4 py-4 text-gray-900">${item.category}</td>
                    ...
                    <td class="px-4 py-4 text-gray-900">${item.approved}</td>

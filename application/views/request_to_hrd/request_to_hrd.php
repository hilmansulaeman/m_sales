...
<html lang="en">
  ...
  <body>
    ...
    <script>
      initLayout("Request to HRD", "Exit");
      ...
      function renderTable() {
        ...
        if (paginatedItems.length === 0) {
          tbody.innerHTML =
            '<tr><td colspan="8" class="text-center py-4 text-gray-500">No data found</td></tr>';
          return;
        }
          ...
          .map(
            (item, index) => `
                <tr class="hover:bg-gray-50 border-b border-gray-100">
                    ...
                    <td class="px-4 py-4 text-gray-900">${item.action}</td>
                </tr>
            `
          )
          .join("");

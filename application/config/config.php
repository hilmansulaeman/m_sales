...
|
*/
// Auto-detect base URL (works on PHP built-in server and Apache/Laragon)
if (isset($_SERVER['HTTP_HOST'])) {
    $protocol = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
    $host     = $_SERVER['HTTP_HOST']; // includes port if non-standard, e.g. localhost:8001
    $script   = $_SERVER['SCRIPT_NAME']; // e.g. /index.php or /m_sales/index.php
    $base     = rtrim(dirname($script), '/\\') . '/';
    $config['base_url'] = $protocol . '://' . $host . $base;
} else {
    $config['base_url'] = 'http://localhost/m_sales/';
}

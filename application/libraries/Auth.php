...
class Auth
{
	...
	function do_login($username, $password)
	{
		...
		// API URL
		$url =  $apiUrl . 'api/user/login_saless?username=' . $username . '&password=' . $password;
		...
		if ($responStatus == '1') {
			...
			$session_data = array(
				...
				'sm_code'	=> $userdata->SM_Code,
				'sm_name'	=> $userdata->SM_Name,

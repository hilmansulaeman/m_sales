...
class Reaktif_form_model extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $where = "a.Form_ID = '7' AND ($checker OR $approval)";
    ...
    function get_reaktif_detail($request_id)
    {
        $username = $this->session->userdata('username');
        ...
        // WHERE a.Request_ID = '$request_id' AND e.Form_ID = '7' AND d.Sales_Code = '$username' AND d.Status = '0'
    ...
    function insert_data_api($data, $position)
    {
        // echo '<pre>';
        // print_r($data);
        // echo '</pre>';
        ...
        // API URL
        if($position == 'bsh') {
            $url = $url_api . '/api/request/add_reaktif';
        }
        else {
            $url = $url_api . '/api/request/update_reaktif';
        }

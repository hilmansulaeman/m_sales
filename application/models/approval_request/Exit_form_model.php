...
class Exit_form_model extends CI_Model
{
	...
	private function _get_datatables_query()
    {
        ...
        $approval = "b.Approval = '$username' AND b.Hit_Code IN('1008','1005')";

        //$where = "a.Form_ID = '1' AND ($checker OR $approval)  AND a.Created_Date BETWEEN '$tanggal1' AND '$tanggal2'";
        $where = "a.Form_ID = '1' AND ($checker OR $approval)";
    ...
    function get_exit_detail($request_id, $form_id, $checker) {
        ...
        if($username == $checker) {
            ...
            $where = " AND a.Checker_Status = '1'";
        }
        return $getData = $this->db->query("SELECT a.*, b.*, c.*, d.Status, d.Resign_Date, Resign_Date2, d.Employee_ID
            ...
            WHERE a.Request_ID = '$request_id' AND b.Form_ID = '$form_id' $where

...
class Restruct_form_model extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        //$where = "a.Form_ID = '3' AND ($checker OR $approval)";
        $where = "a.Form_ID = '3' AND $approval";
    ...
    function get_restruct_detail($request_id)
    {
        ...
        return $getData = $this->db->query("SELECT a.*, b.*, c.Employee_ID, e.*,d.Status
            ...
            WHERE a.Request_ID = '$request_id' AND e.Form_ID = '3' AND d.Sales_Code = '$username' AND d.Status = '0'

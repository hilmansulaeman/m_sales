...
class Ebranch_model extends CI_Model
{
    ...
    public function check_cc_exist($sales_code,$created_date){
        $getAPI = $this->db->get_where('key_api', array('Description' => 'CC'));
        $rowAPI = $getAPI->row();
        ...
        $url = $rowAPI->url . 'cc/ebranch/getCC_sales_code_tanggal?sales_code='.$sales_code.'&created_date='.$created_date;

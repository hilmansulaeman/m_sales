...
class Bcas_model extends CI_Model
{
	...
	function get_datatables($where)
	{
		...
		$getAPI = $this->db->query("SELECT * FROM `key_api` WHERE `Description` = 'BCAS'");
	...
	function get_pemol($var,$sales,$from,$to)
	{
		...
		// API URL
		$url = $rowAPI->url.'api/summary_api/getPemol?var='.$var.'&sales='.$sales.'&from='.$from.'&to='.$to;
	...
	// get pemol dummy
	function get_pemol_dummy($sales,$from,$to,$part)
	{
		$getAPI = $this->db->query("SELECT * FROM `key_api` WHERE `Description` = 'BCAS'");
		$rowAPI = $getAPI->row();
		...
		// API URL
		$url = $rowAPI->url.'api/summary_api/getPemolDummy?sales='.$sales.'&from='.$from.'&to='.$to.'&part='.$part;
	...
	function getBreakdownPemolBcasexport($date_from, $date_to)
	{
		...
		// API URL
		$url = $rowAPI->url.'api/summary_api/getPemolExport?nik='.$nik.'&position='.$position.'&date_from='.$date_from.'&date_to='.$date_to;

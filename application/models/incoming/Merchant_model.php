...
class Merchant_model extends CI_Model
{
	...
	function fetchBulkMerchantSummary($lead_column, array $sales_list, $from, $to, $source = '')
	{
		$rowAPI = $this->db->select('*')
					->from('key_api')
					->where('Description', 'Rest API')
					->get()
					->row();
		...
		$dataDecode = json_decode($result, true); // Add true to decode as associative array

...
class Dashboard extends MY_Controller 
{
    ...
    function __construct()
    {
        ...
        $this->load->helper(array('url', 'html', 'global'));
        $this->load->model(array('dashboard_model', 'addendum_model'));
			...
			// $info = "Berikut peraturan perundang-undangan yang berlaku tentang pelindungan data pribadi:<br>
			// 1. Undang – undang No 27 Tahun 2022 tentang Pelindungan Data Pribadi (“UU PDP”).<br>
			// 2. Peraturan Pemerintah Nomor 71 Tahun 2019 tentang Penyelenggaraan Sistem dan Transaksi Elektronik.<br>
			// 3. Peraturan Menteri Komunikasi dan Informatika No. 20 Tahun 2016 tentang Pelindungan Data Pribadi dalam Sistem Elektronik, dan/atau peraturan terkait pelindungan Data Pribadi lain'<br><br>

			// Berkaitan dengan hal tersebut, mohon agar dapat melakukan tanda tangan terlebih dahulu FORM NDA terlampir.";

			
            $info = "Mohon lakukan tanda tangan Addendum Mitra Penambahan point Rambu Dan Larangan terlampir. Terlampir tambahan poin poin rambu dan larangan nya:<br>
            1. Tidak menggunakan tanda pengenal diri (ID Card) pada waktu menjalankan tugas dan selama dalam lingkungan Pihak Pertama atau Klien tanpa alasan yang dapat diterima.<br>
            2. Tidak diperbolehkan melakukan tugas – tugas termasuk melakukan akuisisi, apabila Pihak Kedua belum melakukan tanda tangan Perjanjian kemitraan dengan Pihak Pertama , memiliki salescode dan/atau belum mengikuti pelatihan yang selenggarakan Pihak Pertama.<br>
            3. Tidak diperkenankan memalsukan, memberikan keterangan palsu, memanipulasi, mengganti database baik itu data customer/ calon customer maupun data-data lainnya termasuk di dalamnya dokumen pendukung.<br>
            4. Tidak diperbolehkan meminjamkan/ membuat sendiri ID Card yang mengakibatkan kerugian Pihak Pertama atau Klien.<br><br>
            Berkaitan dengan hal tersebut, mohon agar dapat melakukan tanda tangan terlebih dahulu Addendum Mitra Penambahan point Rambu Dan Larangan terlampir.
            ";

...
class Addendum extends MY_Controller
{
    ...
    {
        $query = $this->Addendum_model->get_all_data();
        // var_dump($query); die();
        $data = array();
		$no = 1;
    ...
    function view($id)
    {
        ...
        if($rows->agreement != ""){
            ...
            $src = site_url("addendum/preview/".$id);
            // $src = $this->preview($id);
        }
                ...
                foreach ($signature->result() as $item) {
                    ...
                    if ($signature_user_ == 'PIC') {
                        ...
                        // else {
                            ...
                            $this->f_pdf->pdf->SetXY($item->Set_X, $item->Set_Y);
                            $this->f_pdf->pdf->Image($signature_employee, null, null, 100);
                        // }
    ...
    function submit()
    {
        ...
        $this->Addendum_model->update($data_update,$id);
    ...
    private function set_file_name($type = "agreement")
    {

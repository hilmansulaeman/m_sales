...
class Ebranch extends MY_Controller
{
    ...
    public function add()
    {
        ...
        //     'required' => '{field} harus di isi!',
        // ]);
        $this->form_validation->set_rules('no_referensi', 'No Referensi', 'trim|required|min_length[10]|max_length[10]|callback_cek_noref', [
            'required' => '{field} harus di isi!',
        ...
        if ($this->form_validation->run() == false) {
			...
			//$this->load->view('input/ebranch/index_maintenance');
        } else {

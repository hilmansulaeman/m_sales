                    ...
                    if (count($check_cc_data) >= $data_event->limit) {
                        ...
                        $this->session->set_flashdata('message', '<div class="alert alert-danger alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <b>Input harian untuk produk Credit Card (CC) adalah ' . $data_event->limit . ' aplikasi per sales per hari</b>
                            </div>');
                ...
                if ($get_data_limit->num_rows() > 0) {
                    ...
                    if (count($check_cc_data) > 0) {
                        ...
                        if (count($check_cc_data) >= $data_limit->limit) {
                            ...
                            $this->session->set_flashdata('message', '<div class="alert alert-danger alert-dismissible">
                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                <b>Input harian untuk produk Credit Card (CC) adalah ' . $data_limit->limit . ' aplikasi per sales per hari</b>
                            </div>');

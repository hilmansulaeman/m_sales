...
class Prodemo_form extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('request/prodemo_form_model');
    }
    ...
    function index()
    {
        ...
        $data['kategori'] = $this->prodemo_form_model->get_kategori_prodemo();


        //load view
        $this->template->set('title', 'Data Form Promosi & Demosi');
        $this->template->load('template', 'request/prodemo/index', $data);
    }
    ...
    function get_data_prodemo()
    {
        $query = $this->prodemo_form_model->get_datatables();
        $count_data = $this->prodemo_form_model->count_all()->row();
        ...
        $output = array(
            ...
            "recordsFiltered" => $this->prodemo_form_model->count_filtered(),
            "data" => $data,
        );
    ...
    function detail($request_id)
    {
        ...
        $this->template->load('template', 'request/demosi_form/detail', $data);
    }

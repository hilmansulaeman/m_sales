...
* 
*/
class Filter_incoming_edc extends MY_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('incoming/edc_model');
	}
	...
	function index($tgl1, $tgl2)
	{
		...
		$data['breakdown_edc'] = $this->edc_model->m_breakdown_edc($sales_code, $tgl1, $tgl2);
        //load view

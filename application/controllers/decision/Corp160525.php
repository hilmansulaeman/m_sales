	...
	function get_data_spv()
	{
		...
		foreach ($query->result() as $row) {
			...
			$data[] = array(
				++$no,
				$sales_code . ', ' . $sales_name . ' (' . $sales_position . ')',
				'<a href="' . site_url('decision/corp/detailActualLink/' . $sales_code . '/APPROVE/' . $sales_name) . '" target="_blank"><span title="Total Accept Approve" class="badge bg-green">' . $getActualStatus->approve_corp . '</span></a>',
				'<a href="' . site_url('decision/corp/detailActualLink/' . $sales_code . '/CANCEL/' . $sales_name) . '" target="_blank"><span title="Total Accept Cancel" class="badge bg-red">' . $getActualStatus->cancel_corp . '</span></a>',
				'<a href="' . site_url('decision/corp/detailActualLink/' . $sales_code . '/DECLINE/' . $sales_name) . '" target="_blank"><span title="Total Accept Decline" class="badge bg-black">' . $getActualStatus->decline_corp . '</span></a>',
				$buttons
			);
		}

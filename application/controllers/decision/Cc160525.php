	...
	function get_data_spv()
	{
		...
		foreach ($query->result() as $row) {
			...
			$data[] = array(
				++$no,
				$sales_code . ', ' . $sales_name . ' (' . $sales_position . ')',
				'<a href="' . site_url('decision/cc/detailActualLink/' . $sales_code . '/APPROVE/' . $sales_name) . '" target="_blank"><span title="Total Accept Approve" class="badge bg-green">' . $getActualStatus->approve . '</span></a>',
				'<a href="' . site_url('decision/cc/detailActualLink/' . $sales_code . '/INPROCESS/' . $sales_name) . '" target="_blank"><span title="Total Accept In Process" class="badge bg-yellow">' . $getActualStatus->inprocess . '</span></a>',
				'<a href="' . site_url('decision/cc/detailActualLink/' . $sales_code . '/CANCEL/' . $sales_name) . '" target="_blank"><span title="Total Accept Cancel" class="badge bg-red">' . $getActualStatus->cancel . '</span></a>',
				'<a href="' . site_url('decision/cc/detailActualLink/' . $sales_code . '/DECLINE/' . $sales_name) . '" target="_blank"><span title="Total Accept Decline" class="badge bg-black">' . $getActualStatus->decline . '</span></a>',
				$buttons
			);
		}
